...
export default function Login(props) {
  ...
  const SubmitRegister = async () => {
    ...
    console.log(account);
    const response = await fetch(`http://frontend-final-project-topaz.vercel.app/auth/register`, {
      method: 'POST',
  ...
  const SubmitLogin = async () => {
    ...
    try {
      const response = await fetch(`http://frontend-final-project-topaz.vercel.app/auth/login`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      if (data) {
        ...
        if (getStocks.length > 0) {
          ...
          const url = `http://frontend-final-project-topaz.vercel.app/stock/information?parems=${editedStocksStr}`;
          const options = {
            method: 'GET',
            headers: {
        ...
        const urlStories = 'http://frontend-final-project-topaz.vercel.app/stock/stories';
