        ...
        <Box sx={{height: '100%'}}>
          ...
          <Box sx={{display: 'inline-flex', width: '100%', marginBottom: '20px'}}>
            <TextField 
              id="Industry"
              label="Industry"
              defaultValue={ToInitialCase(stockData.Industry)}
              variant="standard"
              ...
              id="Sector"
              label="Sector"
              defaultValue={ToInitialCase(stockData.Sector)}
              variant="standard"
              sx={{margin: '5px', width: '33%'}}
              InputProps={{readOnly:true}}
              />
              ...
              id="Type"
              label="Type"
              defaultValue={ToInitialCase(stockData.AssetType.toUpperCase())}
              variant="standard"
              sx={{margin: '5px', width: '33%'}}
              InputProps={{readOnly:true}}
              />
      ...
      <Box sx={{height: '100%'}}>
          ...
          <Box sx={{display: 'inline-flex', width: '100%', marginBottom: '20px'}}>
            <TextField 
              ...
              id="Type"
              label="Type"
              defaultValue={ToInitialCase(stockData.AssetType)}
              variant="standard"
              sx={{margin: '5px', width: '33%'}}
              InputProps={{readOnly:true}}
              InputLabelProps={LabelProperties}
        ...
        <Box sx={{display: 'flex', justifyContent: 'center', marginBottom: '20px', marginTop: '20px'}}>
          <Box sx={{display:'flex', flexDirection: 'column', width: '30%', alignItems: 'flex-end'}}>
            <Box sx={AnalyticBoxStyle}>
              ...
              id="fiveTwoWeekHigh"
              label="52 Week High"
              defaultValue={Monify(stockData['52WeekHigh'])}
              variant="standard"
              sx={{width: '100%'}}
            ...
            <Box sx={AnalyticBoxStyle}>
              ...
              defaultValue={Monify(stockData.DividendPerShare)}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
            ...
            <Box sx={AnalyticBoxStyle}>
              ...
              id="PERatio"
              label="PE Ratio"
              defaultValue={stockData.PERatio}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
          ...
          <Box sx={{display:'flex', flexDirection: 'column', width: '30%', alignItems: 'center'}}>
            <Box sx={AnalyticBoxStyle}>
              ...
              id="fivetwoWeekLow"
              label="50 Week Low"
              defaultValue={Monify(stockData['52WeekLow'])}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
            ...
            <Box sx={AnalyticBoxStyle}>
              ...
              defaultValue={stockData.DividendYield}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
            ...
            <Box sx={AnalyticBoxStyle}>
              ...
              id="ProfitMargin"
              label="Profit Margin"
              defaultValue={stockData.ProfitMargin}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
          ...
          <Box sx={{display:'flex', flexDirection: 'column', width: '30%', alignItems: 'flex-start'}}>
            <Box sx={AnalyticBoxStyle}>
              ...
              defaultValue={Monify(stockData['50DayMovingAverage'])}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
            ...
            <Box sx={AnalyticBoxStyle}>
              ...
              defaultValue={stockData.ReturnOnAssetsTTM}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
            ...
            <Box sx={AnalyticBoxStyle}>
              ...
              defaultValue={stockData.ReturnOnEquityTTM}
              variant="standard"
              sx={{width: '100%'}}
              inputProps={InputStyles}
              InputProps={InputAttributes}
